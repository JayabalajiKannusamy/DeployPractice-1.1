...
#SELECT THE PROJECT
    #PROJECT NAME: TEST AUTOMATED CSS
    Sleep  8
...
#SELECT THE CLIENT PULSE
    Click Element  XPATH://*[@id="feature1"]/div/p[2]/span/span
    Sleep  6
...
#CLICK X MARK IN POPUP
    ...
    Capture Page Screenshot  C:\Users\Jayabalaji.K\PycharmProjects\CodexStage\Page1.png
    Sleep  3
...
#SELECT PROJECT NAME
    ...
    Input Text  XPATH://*[@id="midContainer"]/div/div[2]/div[1]/div/div[1]/input  Two Project Linking Test
# Project name : TWO PROJECT LINK #
    Sleep  3
...
#SELECT STAKAHOLDER FEATURE
    Scroll Element Into View  XPATH://*[@id="feature10"]/div/p[2]/span
    Click Element  XPATH://*[@id="feature10"]/div/p[2]/span
...
#ADD PHONE NUMBER
    ...
    Input Text  XPATH:/html/body/codex-root/div[1]/home/div/app-stakeholder/div[4]/div/div/div[2]/form/div[2]/div[1]/input   8610025551
#Click UPDATE
...
#BACK TO HOME
    Sleep  3
    Click Element  XPATH:/html/body/codex-root/div[1]/home/app-header/div[1]/div[13]/div[1]/div/span[2]/ul/li/span[1]
...
#SELECT THE ESCALATION/WARNING
    ...
    Sleep  5
    Capture Page Screenshot   C:\Users\Jayabalaji.K\PycharmProjects\CodexStage\Esccalation.png
...
#SELECT THE PROJECT GOVERNANCE
    ...
    Sleep  3
#Back to FEATURE
    Wait Until Element Is Enabled  XPATH:/html/body/codex-root/div[1]/home/div/app-new-governance/div[1]/div/div[1]/span
    Click Element  XPATH:/html/body/codex-root/div[1]/home/div/app-new-governance/div[1]/div/div[1]/span
    Sleep  5
...
#BACK TO FEATURE
    Click Element  XPATH:/html/body/codex-root/div[1]/home/div/app-newproject-config/div[1]/div/div/span
    Sleep  5
